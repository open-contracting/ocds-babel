                        ...
                        "oneOf": [
                            {
                                ...
                                "description": "Una lista de objetos que identifican las entregas asociadas con este Open…",  # noqa: E501
                            },
                            {
                                "title": "Entregas embebidas",
                                "description": "Una lista de entregas, con todos los datos. Las entregas DEBEN ordenarse…",  # noqa: E501
                            },
                        ],
                    }
                }
...
def test_translate_extension_metadata(monkeypatch, caplog):
    ...
    for metadata in (extension_metadata, extension_metadata_language_map):
        ...
        assert data == {
            "name": {"es": "Ubicación"},
            "description": {"es": "Comunica la ubicación de la entrega del contrato propuesto o ejecutado."},
            "compatibility": ["1.1"],
        }
  ...
  "documents": [
    {
      ...
      "url": "http://example.com/documents/procurementStrategyRiskAssessment.pdf"
            ...
            "fields": ["/documents", "/documents/id", "/documents/title", "/documents/documentType", "/documents/url"],
            "refs": "",
        },
        {
            "id": "1.2",
